...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased bg-[#000] md:bg-[#c2bcb3] dark:md:bg-[#000]">
        <div class="min-h-screen flex flex-col items-center md:pt-6">
            <div class="md:bg-[url('/tv.png')] dark:md:bg-[url('/tv-black.png')] bg-center bg-contain bg-no-repeat w-full md:w-[1024px] md:h-[924px] flex flex-col items-center min-h-screen md:min-h-0">
